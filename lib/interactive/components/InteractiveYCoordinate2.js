...
var InteractiveYCoordinate2 = function (_Component) {
	_inherits(InteractiveYCoordinate2, _Component);

	function InteractiveYCoordinate2(props) {
		_classCallCheck(this, InteractiveYCoordinate2);

		var _this = _possibleConstructorReturn(this, (InteractiveYCoordinate2.__proto__ || Object.getPrototypeOf(InteractiveYCoordinate2)).call(this, props));
	...
	_createClass(InteractiveYCoordinate2, [{
		key: "isHover",
		value: function isHover(moreProps) {
			...
			if ((0, _utils.isDefined)(onHover)) {
				...
				if (mouseX >= rect.x && mouseX <= rect.x + this.props.textBox.width && mouseY >= rect.y && mouseY <= rect.y + rect.height) {
					return true;
				}
		...
		value: function renderSVG(moreProps) {
			var _props = this.props,
			    ...
			    strokeDasharray = _props.strokeDasharray,
				text = _props.text,
				rectWidth = _props.textBox.width,
				rectHeight = _props.textBox.height,
			    edge = _props.edge;
			var _props2 = this.props,
			    selected = _props2.selected,
				hovering = _props2.hovering;
			...
			var lineCoordinates = { x1: 0, y1: Math.round(yScale(yValue)), x2: moreProps.width, y2: Math.round(yScale(yValue))};
			return [
			...
			_react2.default.createElement("rect",{
				key: "iyc2",
				x: moreProps.width-rectWidth-1,
				y: lineCoordinates.y1-rectHeight/2,
				width: rectWidth,
				height: rectHeight,
				fill: bgFill,
				style: {
			...
			_react2.default.createElement("rect",{
				key: "vbar1",
				x: moreProps.width-rectWidth+4,
				y: lineCoordinates.y1-rectHeight/2 + 6,
				width: 13,
				height: 2,
				fill: "#c2c2c2"
			}),
			_react2.default.createElement("rect",{
				key: "vbar2",
				x: moreProps.width-rectWidth+4,
				y: lineCoordinates.y1-rectHeight/2 + 11,
				width: 13,
				height: 2,
				fill: "#c2c2c2"
			}),
			_react2.default.createElement("rect",{
				key: "vbar3",
				x: moreProps.width-rectWidth+4,
				y: lineCoordinates.y1-rectHeight/2 + 16,
				width: 13,
				height: 2,
				fill: "#c2c2c2"
			}),
			_react2.default.createElement("text",{
				key: "iyc3",
				x: moreProps.width- rectWidth + 23,
				y: lineCoordinates.y1+4,
				fontFamily: fontFamily,
				fontSize: fontSize,
				fontStyle: fontStyle,
	...
	return InteractiveYCoordinate2;
}(_react.Component);
...
InteractiveYCoordinate2.propTypes = {
...
InteractiveYCoordinate2.defaultProps = {
...
exports.default = InteractiveYCoordinate2;
