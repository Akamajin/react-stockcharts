...
var _EachInteractiveYCoordinateTrade = require("./wrapper/EachInteractiveYCoordinateTrade");

var _EachInteractiveYCoordinateTrade2 = _interopRequireDefault(_EachInteractiveYCoordinateTrade);
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				yCoordinateList.map(function (each, idx) {
					var props = each;
					return _react2.default.createElement(_EachInteractiveYCoordinateTrade2.default, _extends({ key: each.id,
...
InteractiveYCoordinateTrade.contextTypes = {
