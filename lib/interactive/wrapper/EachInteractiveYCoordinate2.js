...
var _InteractiveYCoordinate = require("../components/InteractiveYCoordinate2");
...
var EachInteractiveYCoordinate2 = function (_Component) {
	_inherits(EachInteractiveYCoordinate2, _Component);

	function EachInteractiveYCoordinate2(props) {
		_classCallCheck(this, EachInteractiveYCoordinate2);

		var _this = _possibleConstructorReturn(this, (EachInteractiveYCoordinate2.__proto__ || Object.getPrototypeOf(EachInteractiveYCoordinate2)).call(this, props));
	...
	_createClass(EachInteractiveYCoordinate2, [{
		key: "handleDragStart",
	...
	return EachInteractiveYCoordinate2;
}(_react.Component);

EachInteractiveYCoordinate2.propTypes = {
...
EachInteractiveYCoordinate2.defaultProps = {
	onDrag: _utils.noop,
...
exports.default = EachInteractiveYCoordinate2;
