...
var _InteractiveYCoordinateTrade = require("../components/InteractiveYCoordinateTrade");

var _InteractiveYCoordinateTrade2 = _interopRequireDefault(_InteractiveYCoordinateTrade);
...
var EachInteractiveYCoordinateTrade = function (_Component) {
	_inherits(EachInteractiveYCoordinateTrade, _Component);

	function EachInteractiveYCoordinateTrade(props) {
		_classCallCheck(this, EachInteractiveYCoordinateTrade);

		var _this = _possibleConstructorReturn(this, (EachInteractiveYCoordinateTrade.__proto__ || Object.getPrototypeOf(EachInteractiveYCoordinateTrade)).call(this, props));
	...
	_createClass(EachInteractiveYCoordinateTrade, [{
		key: "handleDragStart",
		...
		value: function render() {
			var _props3 = this.props,
				...
				startX = _props3.startX,
				labelStartX = _props3.labelStartX,
				profitText = _props3.profitText,
				uid = _props3.uid,
				onCloseTrade = _props3.onCloseTrade,
			...
			return _react2.default.createElement(
				"g",
				null,
				_react2.default.createElement(_InteractiveYCoordinateTrade2.default, _extends({
	...
	return EachInteractiveYCoordinateTrade;
}(_react.Component);

EachInteractiveYCoordinateTrade.propTypes = {
	...
	onCloseTrade: _propTypes2.default.func.isRequired,
...
EachInteractiveYCoordinateTrade.defaultProps = {
	onDrag: _utils.noop,
...
exports.default = EachInteractiveYCoordinateTrade;