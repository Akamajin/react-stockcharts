...
var StraightLine = function (_Component) {
	...
	_createClass(StraightLine, [{
		...
		value: function renderSVG(moreProps) {
			...
			var stickToSides = _props3.stickToSides;
			var lineCoordinates = getLineCoordinates(type, xScale, yScale, xValue, yValue, width, height, stickToSides);
			var gradient1 = _react2.default.createElement("linearGradient", {id: "golden", key: 'gr1', gradientTransform: 'rotate(90)'}, [
					_react2.default.createElement("stop", {key: 'stp1', offset: "0%", stopColor: stroke, stopOpacity: stickToSides === 'top' ? 0 : 1 }),
					_react2.default.createElement("stop", {key: 'stp2', offset: "100%", stopColor: stroke, stopOpacity: stickToSides === 'top' ? 1 : 0 })
				]);
			var fillBottom = _react2.default.createElement("rect", {
					key: 'fb',
					className: className,
					x: 0,
					y: lineCoordinates.y1,
					height: height-lineCoordinates.y1 < 0 ? 0 : height-lineCoordinates.y1,
					width: width,
					fill: "url('#golden')",
					opacity: 0.5
				});
			var fillTop = _react2.default.createElement("rect", {
					key: 'ft',
					className: className,
					x: 0,
					y: 0,
					height: lineCoordinates.y1 < lineCoordinates.y1 ? 0 : lineCoordinates.y1,
					width: width,
					fill: "url('#golden')",
					opacity: 0.5
				});
			if (stickToSides === "top") {
				return [gradient1, fillTop];
			} else if (stickToSides === "bottom") {
				return [gradient1, fillBottom]
			}else {
...
StraightLine.propTypes = {
	...
	stickToSides: _propTypes2.default.oneOf(["top", "bottom"]),
